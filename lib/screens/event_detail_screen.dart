...
class _EventDetailsPageState extends State<EventDetailsPage> {
  ...
  Future<void> _loadPreferences() async {
    ...
    setState(() {
      ...
      isBookmarkYellow = isBookmarked; // Initialize isBookmarkYellow based on isBookmarked
    });
  }
  ...
  Future<void> _toggleBookmark() async {
    setState(() {
      ...
      isBookmarkYellow = isBookmarked; // Update isBookmarkYellow based on isBookmarked
    });
    ...
    if (isBookmarked) {
      ...
      savedEvents.removeWhere(
          (eventData) => eventData['name'] == widget.eventName);
      await _prefs.setStringList(
          'savedEvents',
          savedEvents
              .map((eventData) =>
        ...
        actions: [
          IconButton(
            icon: Icon(
              ...
              color: isBookmarkYellow ? Colors.yellow : null, // Set color based on isBookmarkYellow
            ),
